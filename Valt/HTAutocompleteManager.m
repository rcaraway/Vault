...
-(NSDictionary *)titleUrlPairs
{
    return @{@"Gmail": @"http://www.gmail.com",
             ...
             @"Something Aweful Forums" : @"http://forums.somethingawful.com",
             ...
             @"ComEd" : @"https://www.comed.com/Pages/default.aspx",
             @"conEdison" : @"http://www.coned.com/",
             @"Georgia Power" : @"http://www.georgiapower.com/",
             @"Dominion" : @"https://www.dom.com/",
             @"DTE Energy" : @"https://www2.dteenergy.com",
             @"TXU Energy" : @"http://www.txuenergy.com/",
